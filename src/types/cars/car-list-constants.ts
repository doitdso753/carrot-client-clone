...
export const CAR_LIST_ITEMS: CarListItem[] = [
  ...
  },
  {
    id: 111,
    transactionType: 'sale',
    title: '아반떼(CN7) 1.6 가솔린 인스퍼레이션',
    priceText: '1,780만원',
    modelYearText: '22년식',
    mileageText: '3.2만km',
    location: '신당동',
    address: '서울특별시 중구 신당동',
    createdAt: '2026-08-28T17:30:00+09:00',
    commentCount: 2,
    favoriteCount: 14,
    viewCount: 184,
    description: CAR_DETAIL_DESCRIPTION,
    ...
    vehicleInfo: CAR_VEHICLE_INFO,
    insuranceInfo: CAR_INSURANCE_INFO,
    imageUrls: getCarDetailImageUrls(0, 6),
    thumbnailImageUrl: 'https://picsum.photos/seed/sindang-car-avante/900/600',
  },
  {
    id: 112,
    transactionType: 'sale',
    title: '셀토스 1.6 가솔린 터보 2WD 프레스티지',
    priceText: '2,150만원',
    modelYearText: '23년식',
    mileageText: '2.1만km',
    location: '신당동',
    address: '서울특별시 중구 신당동',
    createdAt: '2026-08-28T13:20:00+09:00',
    commentCount: 1,
    favoriteCount: 19,
    viewCount: 221,
    description: CAR_DETAIL_DESCRIPTION,
    ...
    vehicleInfo: CAR_VEHICLE_INFO,
    insuranceInfo: CAR_INSURANCE_INFO,
    imageUrls: getCarDetailImageUrls(2, 7),
    thumbnailImageUrl: 'https://picsum.photos/seed/sindang-car-seltos/900/600',
  },
  {
    id: 113,
    transactionType: 'sale',
    title: '그랜저IG 2.4 프리미엄',
    status: 'reserved',
    priceText: '1,490만원',
    modelYearText: '19년식',
    mileageText: '7.8만km',
    location: '신당동',
    address: '서울특별시 중구 신당동',
    createdAt: '2026-08-27T19:00:00+09:00',
    commentCount: 5,
    favoriteCount: 31,
    viewCount: 407,
    description: CAR_DETAIL_DESCRIPTION,
    ...
    vehicleInfo: CAR_VEHICLE_INFO,
    insuranceInfo: CAR_INSURANCE_INFO,
    imageUrls: getCarDetailImageUrls(4, 8),
    thumbnailImageUrl:
      'https://picsum.photos/seed/sindang-car-grandeur/900/600',
  },
  {
    id: 114,
    transactionType: 'sale',
    title: '레이 1.0 가솔린 프레스티지',
    priceText: '980만원',
    modelYearText: '20년식',
    mileageText: '5.4만km',
    location: '신당동',
    address: '서울특별시 중구 신당동',
    createdAt: '2026-08-27T14:40:00+09:00',
    commentCount: 3,
    favoriteCount: 22,
    viewCount: 276,
    description: CAR_DETAIL_DESCRIPTION,
    ...
    vehicleInfo: CAR_VEHICLE_INFO,
    insuranceInfo: CAR_INSURANCE_INFO,
    imageUrls: getCarDetailImageUrls(6, 6),
    thumbnailImageUrl: 'https://picsum.photos/seed/sindang-car-ray/900/600',
  },
  {
    id: 115,
    transactionType: 'lease',
    title: '아이오닉 5 롱레인지 익스클루시브',
    priceText: '리스 58만원/월',
    modelYearText: '24년식',
    mileageText: '1.6만km',
    location: '신당동',
    ...
    leaseInfo: {
      remainingMonths: 28,
      totalMonthlyPayment: '1,624만원',
      acquisitionPayment: '300만원',
      maturityAmount: '2,400만원',
      earlyTerminationAmount: '2,760만원',
      totalAcquisitionCost: '4,324만원',
    },
    imageUrls: getCarDetailImageUrls(8, 7),
    thumbnailImageUrl: 'https://picsum.photos/seed/sindang-car-ioniq5/900/600',
  },
];
