export function CommentTextIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      width="18"
      height="18"
      className="sprinkles_color_neutralSubtle__1byufe82 _1fclgnm5"
      aria-hidden="true"
    >
      <g>
        <path
